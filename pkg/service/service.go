...
// endpointManager is used to determine if a backend is a node-local endpoint
...
func NewService(monitorNotify monitorNotify, endpointManager endpointManager) *Service {
	return &Service{
		svcByHash:       map[string]*svcInfo{},
		svcByID:         map[lb.ID]*svcInfo{},
		backendRefCount: counter.StringCounter{},
